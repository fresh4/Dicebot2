...
VERSION_NUMBER = /* 5ETOOLS_VERSION__OPEN */"1.81.2"/* 5ETOOLS_VERSION__CLOSE */;
				...
				(async () => {
					...
					dataList.forEach((it, i) => {
						...
						<li ${FLTR_ID}="${i}" class="not-clickable">
							<section>
								<span class="col-4 name manbrew__load_from_url pl-0 clickable" onclick="BrewUtil.addBrewRemote(this, '${(it.download_url || "").encodeApos().escapeQuotes()}', true)">${it._brewName}</span>
